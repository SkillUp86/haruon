                                    ...
                                    <div class="mail-box-container">
                                        ...
                                        <div class="tab-title">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-12 text-center mail-btn-container">
                                                    <a id="btn-compose-mail" class="btn btn-block _effect--ripple waves-effect waves-light" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></a>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-12 mail-categories-container">
    
                                                    <div class="mail-sidebar-scroll ps ps--active-y">
                                                        ...
                                                        <ul class="nav nav-pills d-block" id="pills-tab" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link list-actions active" id="mailInbox"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox">
	                                                                ...
	                                                                <span class="nav-names">받은 쪽지함</span> <span class="mail-badge badge">4</span>
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link list-actions" id="sentmail"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-send">
	                                                                <line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg> 
	                                                                <span class="nav-names">보낸 쪽지함</span>
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link list-actions" id="draft"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
	                                                                ...
	                                                                <span class="nav-names">임시보관</span> <span class="mail-badge badge">2</span>
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                        ...
                                        <div id="mailbox-inbox" class="accordion mailbox-inbox">
                                            ...
                                            <div class="message-box">
                                                ...
                                                <div class="ps__rail-x" style="left: 0px; bottom: 0px; display: none;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 458px; right: 0px; display: none;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 187px;"></div></div></div>
                                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button id="btn-save" class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save</button>
                                                    <button id="btn-reply-save" class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save Reply</button>
                                                    <button id="btn-fwd-save" class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save Fwd</button>
                                                    ...
                                                    <button id="btn-reply" class="btn btn-primary _effect--ripple waves-effect waves-light"> Reply</button>
                                                    <button id="btn-fwd" class="btn btn-primary _effect--ripple waves-effect waves-light"> Forward</button>
                                                    <button id="btn-send" class="btn btn-primary _effect--ripple waves-effect waves-light"> Send</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
