                                ...
                                <div class="bold-box">
                                    ...
                                    <form id="formUpdateBasic" action="${pageContext.request.contextPath}/draft/update/basicDraft" method="post" enctype="multipart/form-data">
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control" rows="10" id="textContent" name="textContent">${d.content}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <c:if test="${d.referEmpNo != null}">
                                            <div class="input-group mb-2">
                                                <div class="input-group">
                                                    <p class="black-text">
                                                        <strong>참조자:${d.referName}</strong></p>
                                                </div>
                                            </div>
                                        </c:if>
                                        ...
                                        <div class="col-xxl-12 col-md-12 mb-4">
                                            <button id="btnUpdateBasic" type="button" class="btn btn-primary w-100">등록</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
