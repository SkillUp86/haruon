                                        ...
                                        <div class="col-sm-12">
                                            <div class="container">
                                                <div class="bold-box">
                                                    ...
                                                    <form id="formUpdateSales" action="${pageContext.request.contextPath}/draft/update/salesDraft" method="post" enctype="multipart/form-data">
                                                        <div class="input-group mb-2 mt-4">
                                                            ...
                                                            <div class="input-group">
	                                                            ...
	                                                            <select type="text" class="form-select" id="fraNo" name="fraNo">
																	<option value="${d.franchiseNo}">${d.franchiseName}</option>
	                                                        ...
	                                                        <div class="input-group mb-1">
	                                                            ...
	                                                            <input class="form-control" type="month" id="ym" name="ym" value="${d.ym}" required>
	                                                            <span class="input-group-text label-text">매출액</span>
	                                                            <input class="form-control" type="number" id="revenue" name="revenue" value="${d.revenue}" required>
	                                                        </div>
														</div>
                                                                ...
                                                                <c:if test="${!draftFiles.isEmpty()}">
                                                                    <div class="d-flex flex-wrap">
                                                                        <c:forEach var="f" items="${draftFiles}">
                                                                            ...
                                                                            <a class="btn btn-danger mt-1 file" href="${pageContext.request.contextPath}/deleteFile/sales?drafNo=${f.drafNo}&draNo=${d.draNo}">삭제</a>
                                                                        </c:forEach>
                                                                    </div>
                                                                </c:if>
                                                            </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                         ...
                                                         <div class="col-xxl-12 col-md-12 mb-4">
				                                            <button id="btnUpdateSales" type="button" class="btn btn-primary w-100">등록</button>
				                                        </div>
                                                    </form>
                                                    </div>
                                                </div>
