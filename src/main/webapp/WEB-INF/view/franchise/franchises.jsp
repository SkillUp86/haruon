...
<head>
    ...
    <link href="${pageContext.request.contextPath}/src/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    
    <link href="${pageContext.request.contextPath}/src/plugins/src/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
	<script src="${pageContext.request.contextPath}/src/plugins/src/fullcalendar/fullcalendar.min.js"></script>
    <link href="${pageContext.request.contextPath}/src/plugins/css/light/fullcalendar/custom-fullcalendar.css" rel="stylesheet" type="text/css" />
    <!-- 페이지 제목 입력칸 -->
...
<body class="layout-boxed">
    ...
    <script src="${pageContext.request.contextPath}/src/plugins/src/fullcalendar/custom-fullcalendar.js"></script>
    <script src="${pageContext.request.contextPath}/src/plugins/src/uuid/uuid4.min.js"></script>
