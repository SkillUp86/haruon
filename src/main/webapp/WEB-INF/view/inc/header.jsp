...
<header class="header navbar navbar-expand-sm expand-header">
	...
	<ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
		...
		<li class="nav-item dropdown notification-dropdown">
			<a onclick="window.open('${pageContext.request.contextPath}/readMe', '_blank', 'width=400px, height=400px;')" type="button" class="btn bg-transparent active nav-link dropdown-toggle" id="notificationDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
