...
public class AttendanceController {
	...
	// (부서원) 근태 승인 (approvalYN 변경)
	@PostMapping("/attendance/modifyApprovalYN")
	public String updateAttendanceApproval(Authentication authentication, @RequestParam List<String> modifyTarget) {
		log.debug("selectBox post parameter, modifyTarget = " + modifyTarget.toString());
		attendanceService.modifyAttendancies(modifyTarget);
